...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.minusFive_action = QtWidgets.QAction(MainWindow)
        self.minusFive_action.setObjectName("minusFive_action")
        self.Zero_action = QtWidgets.QAction(MainWindow)
        self.Zero_action.setObjectName("Zero_action")
        self.Five_action = QtWidgets.QAction(MainWindow)
        self.Five_action.setObjectName("Five_action")
        self.recovery_action = QtWidgets.QAction(MainWindow)
        self.recovery_action.setObjectName("recovery_action")
        ...
        self.menu_6.addAction(self.minusFive_action)
        self.menu_6.addAction(self.Zero_action)
        self.menu_6.addAction(self.Five_action)
        ...
        self.menu_3.addAction(self.recovery_action)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.menu_6.setTitle(_translate("MainWindow", "Переход температуры"))
        ...
        self.minusFive_action.setText(_translate("MainWindow", "Через -5"))
        self.Zero_action.setText(_translate("MainWindow", "Через 0"))
        self.Five_action.setText(_translate("MainWindow", "Через +5"))
        self.recovery_action.setText(_translate("MainWindow", "Восстановдение данных"))
